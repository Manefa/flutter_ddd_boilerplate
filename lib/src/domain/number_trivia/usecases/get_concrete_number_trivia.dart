...
class GetConcreteNumberTriviaUseCase implements UseCaseGetNumberTrivia<Either<RequestException, NumberTrivia>, GetConcreteNumberTriviaRequest> {
  final NumberTriviaRepository _numberTriviaRepository;

  GetConcreteNumberTriviaUseCase(this._numberTriviaRepository);

  @override
  Future<Either<RequestException, NumberTrivia>> call({required GetConcreteNumberTriviaRequest params}) {
    return _numberTriviaRepository.getConcreteNumberTrivia(params);
  }
}
